package BSimReservoirPlanWaveform2;
...
/**
 * Waveform2 equal-histogram temporal-order classification on the frozen
 * Plan Stage 6 / HybridDish / Narma10b claim dish. Seeds 101/202/303.
 * Mechanisms are not retuned. Classes are ORDER_A / ORDER_B / ORDER_C.
 * Stage 6 NARMA-10 remains the provenance checkpoint. Track B is not started.
 */
public final class BSimReservoirPlanWaveform2 {
    ...
    static String OUTPUT_DIR = "results/waveform2_driven_seed101";
    static String INPUT_AHL_FILE = "input_ahl_waveform2_400.txt";
    static String INPUT_ACID_FILE = "input_acid_held05_400.txt";
    static String RUN_LABEL = "waveform2_driven";
    ...
    static final class OutputOwner implements AutoCloseable {
        ...
        public void close() {
            ...
            try {
                ...
                throw new RuntimeException("Cannot close Waveform2 output", e);
            }
        }
    }

    public static void main(String[] args) {
        String configPath = args.length > 0 ? args[0] : "sim_config_waveform2.properties";
        loadConfig(configPath);
        if (args.length > 1 && "preview".equals(args[1])) HEADLESS = false;
        resetStaticState();
        System.out.printf(Locale.US,
                "WAVEFORM2 dish=%.0fx%.0fx%.0f FLOW_SPEED=%.1f AHL_source=(500,250,5) "
        ...
        try {
            ...
            throw new RuntimeException("Cannot open Waveform2 output", e);
        }
        ...
        System.out.printf(Locale.US,
                "Waveform2 complete arm=%s summary_rows=%d expected=%d sample_rows=%d voxel_rows=%d%n",

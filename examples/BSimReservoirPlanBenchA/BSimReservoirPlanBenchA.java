package BSimReservoirPlanBenchA;
...
/**
 * Track A scalar RC benchmarks on the frozen Plan Stage 6 hybrid dish.
 * Lorenz'63 then Mackey-Glass. Mechanisms are not retuned. Stage 6 remains
 * the NARMA-10 provenance checkpoint. Track B is not started.
 */
public final class BSimReservoirPlanBenchA {
    ...
    static String OUTPUT_DIR = "results/lorenz_driven_seed101";
    static String INPUT_AHL_FILE = "input_ahl_lorenz200.txt";
    static String INPUT_ACID_FILE = "input_acid_held05_200.txt";
    static String RUN_LABEL = "bencha_driven";
    ...
    public static void main(String[] args) {
        String configPath = args.length > 0 ? args[0] : "sim_config_bencha.properties";
        ...
        try {
            ...
            throw new RuntimeException("Cannot open Bench A output", e);
        }
        ...
        System.out.printf(Locale.US,
                "BenchA complete arm=%s summary_rows=%d expected=%d sample_rows=%d voxel_rows=%d%n",

package BSimReservoirPlanNarma10b;
 ...
 * New bacterial RNG seeds 111/222/333. Mechanisms are not retuned. Stage 6
 * remains the NARMA-10 provenance checkpoint. Track B is not started.
 */
public final class BSimReservoirPlanNarma10b {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf(Locale.US,
                "Narma10b complete arm=%s summary_rows=%d expected=%d sample_rows=%d voxel_rows=%d%n",

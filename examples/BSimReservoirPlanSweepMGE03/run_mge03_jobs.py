#!/usr/bin/env python3
"""Run the 4 frozen SweepMGE03 production BSim jobs, at most four at a time."""
...
JOBS = [
    "sim_config_mge03_center_f0p25_driven_seed101.properties",
    "sim_config_mge03_center_f0p25_silent_seed101.properties",
    "sim_config_mge03_center_f0p25_brownian_seed101.properties",
    "sim_config_mge03_upstream_f0p0_driven_seed101.properties",
]
...
def main() -> None:
    ...
    if failed:
        ...
        raise SystemExit(1)
    print("all 4 production jobs completed")

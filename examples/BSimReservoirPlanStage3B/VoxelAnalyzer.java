...
public final class VoxelAnalyzer {
    public static final class VoxelReadout {
        public final double[] attractant, repellent, ahl, meanResponse;
        ...
        VoxelReadout(double[] attractant, double[] repellent, double[] ahl,
                     int[] density, double[] meanResponse,
    ...
    public VoxelReadout analyze(BSimChemicalField attractantField,
                                ...
                                List<BSimReservoirPlanStage3B.ReservoirBacterium> bacteria) {
        int total = getStateVoxels();
        double[] attractant = new double[total], repellent = new double[total];
        double[] ahl = new double[total], responseSum = new double[total];
        ...
        for (BSimReservoirPlanStage3B.ReservoirBacterium bacterium : bacteria) {
        ...
        return new VoxelReadout(attractant, repellent, ahl, density, meanResponse,
                fractionQAboveHalf, birthAccum.clone(), deathAccum.clone());
    }

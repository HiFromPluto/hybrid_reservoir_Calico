package BSimReservoirPlanWaveformS;
...
/**
 * WaveformS sine / square / triangle classification on the frozen Plan
 * Stage 6 / HybridDish / Narma10b claim dish. 16 samples per period.
 * Seeds 101/202/303. Mechanisms are not retuned. This is not Waveform2d.
 * Waveform1 GATE_EVIDENCE.md is not edited.
 */
public final class BSimReservoirPlanWaveformS {
    ...
    static String OUTPUT_DIR = "results/waveforms_driven_seed101";
    static String INPUT_AHL_FILE = "input_ahl_waveforms_400.txt";
    static String INPUT_ACID_FILE = "input_acid_held05_400.txt";
    static String RUN_LABEL = "waveforms_driven";
    ...
    static final class OutputOwner implements AutoCloseable {
        ...
        public void close() {
            ...
            try {
                ...
                throw new RuntimeException("Cannot close WaveformS output", e);
            }
        }
    }

    public static void main(String[] args) {
        String configPath = args.length > 0 ? args[0] : "sim_config_waveforms.properties";
        loadConfig(configPath);
        if (args.length > 1 && "preview".equals(args[1])) HEADLESS = false;
        resetStaticState();
        System.out.printf(Locale.US,
                "WAVEFORMS dish=%.0fx%.0fx%.0f FLOW_SPEED=%.1f AHL_source=(500,250,5) "
        ...
        try {
            ...
            throw new RuntimeException("Cannot open WaveformS output", e);
        }
        ...
        System.out.printf(Locale.US,
                "WaveformS complete arm=%s summary_rows=%d expected=%d sample_rows=%d voxel_rows=%d%n",

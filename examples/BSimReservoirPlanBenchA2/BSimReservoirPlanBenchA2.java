package BSimReservoirPlanBenchA2;
...
/**
 * Track A2 subsampled Lorenz'63 on the frozen Plan Stage 6 hybrid dish.
 * SKIP=50 RK4 steps between samples. Mechanisms are not retuned. BenchA
 * Lorenz FAIL and Mackey-Glass PASS are not rewritten. Track B is not started.
 */
public final class BSimReservoirPlanBenchA2 {
    ...
    static String OUTPUT_DIR = "results/lorenz_skip50_driven_seed101";
    static String INPUT_AHL_FILE = "input_ahl_lorenz_skip50.txt";
    static String INPUT_ACID_FILE = "input_acid_held05_200.txt";
    static String RUN_LABEL = "lorenz_skip50_driven";
    ...
    static final class OutputOwner implements AutoCloseable {
        ...
        public void close() {
            ...
            try {
                ...
                throw new RuntimeException("Cannot close Bench A2 output", e);
            }
        }
    }

    public static void main(String[] args) {
        String configPath = args.length > 0 ? args[0] : "sim_config_bencha2.properties";
        ...
        try {
            ...
            throw new RuntimeException("Cannot open Bench A2 output", e);
        }
        ...
        System.out.printf(Locale.US,
                "BenchA2 complete arm=%s summary_rows=%d expected=%d sample_rows=%d voxel_rows=%d%n",

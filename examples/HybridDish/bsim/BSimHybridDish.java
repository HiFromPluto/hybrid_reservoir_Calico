...
/**
 * Hybrid spatial reservoir dish (frozen Stage 6 biology).
 *
 * One-way AHL source, Hill receiver R, luminescence L, acid-held death channel.
 * Do not retune kinetics. Run from the HybridDish folder.
 */
public final class BSimHybridDish {
    ...
    static String OUTPUT_DIR = "output/driven_seed101";
    static String INPUT_AHL_FILE = "input/ahl_narma10.txt";
    static String INPUT_ACID_FILE = "input/acid_held05.txt";
    static String RUN_LABEL = "hybrid_driven";
    ...
    static final class OutputOwner implements AutoCloseable {
        ...
        public void close() {
            ...
            try {
                ...
                throw new RuntimeException("Cannot close HybridDish output", e);
            }
        }
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            throw new RuntimeException("Cannot open HybridDish output", e);
        }
        ...
        sim.setDrawer(new BSimP3DDrawer(sim, 800, 600) {
            ...
            public void scene(PGraphics3D p3d) {
                // Proven 1000x500x10 top-down view. Eye pull-back uses BOUND_Y
                // (500), not BOUND_Z (10). perspective() must follow camera().
        ...
        System.out.printf(Locale.US,
                "Stage6 complete arm=%s summary_rows=%d expected=%d sample_rows=%d voxel_rows=%d%n",
    ...
    /** MATLAB reshape notes, same idea as reservoir_new matlabReshape meta. */
    static void writeMatlabMeta(File directory) throws IOException {
        ...
        try (BufferedWriter w = new BufferedWriter(
            ...
            w.write("see=matlab/load_voxels.m and matlab/ridge_narma10.m\n");
        }
    }

#!/usr/bin/env python3
"""Fast D0b equation and interpolant tests. No long traces. No NARMA."""
...
class TestD0bEquations(unittest.TestCase):
    ...
    def test_history_used_for_negative_time(self) -> None:
        tape = DelayTape(np.array([0.0, 0.0, 0.05, 0.05]), hi_history=0.05)
        self.assertEqual(tape.hi(-5.0), 0.05)
        self.assertEqual(tape.hi(0.0), 0.05)
    ...
    def test_params_match_si_table(self) -> None:
        ...
        self.assertEqual(p["gamma_A"], 15.0)

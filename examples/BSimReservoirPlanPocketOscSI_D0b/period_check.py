#!/usr/bin/env python3
"""NARMA-blind period extractor for the D0b bulk oracle.

Copied from examples/BSimReservoirPlanPocketOscSI_D0/period_check.py.
Peak rules are unchanged. Peak-to-peak of intracellular LuxI I,
frozen in configs/protocol.json.
"""
...
def refuse_narma(argv: list[str] | None = None) -> None:
    ...
    if "narma" in blob or "mackey" in blob:
        raise SystemExit("D0b period checker cannot see a NARMA target.")

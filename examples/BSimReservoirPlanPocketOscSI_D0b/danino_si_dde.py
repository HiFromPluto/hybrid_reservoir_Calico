#!/usr/bin/env python3
"""Danino 2010 SI bulk delay-DDE oracle (D0b copy of D0).

Copied from examples/BSimReservoirPlanPocketOscSI_D0/danino_si_dde.py.
Integrator is not patched. Transcribed from
41586_2010_BFnature08753_MOESM346_ESM.pdf Modeling, not from
DANINO_SI_MODEL.md or PocketOsc-SI.
"""

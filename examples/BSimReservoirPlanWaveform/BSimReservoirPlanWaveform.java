package BSimReservoirPlanWaveform;
...
/**
 * Waveform classification on the frozen Plan Stage 6 hybrid dish.
 * Sine / square / triangle AHL templates. Mechanisms are not retuned.
 * Stage 6 remains the NARMA-10 provenance checkpoint. Track B is not started.
 */
public final class BSimReservoirPlanWaveform {
    ...
    static String OUTPUT_DIR = "results/waveform_driven_seed101";
    static String INPUT_AHL_FILE = "input_ahl_waveform200.txt";
    static String INPUT_ACID_FILE = "input_acid_held05_200.txt";
    static String RUN_LABEL = "waveform_driven";
    ...
    static final class OutputOwner implements AutoCloseable {
        ...
        public void close() {
            ...
            try {
                ...
                throw new RuntimeException("Cannot close Waveform output", e);
            }
        }
    }

    public static void main(String[] args) {
        String configPath = args.length > 0 ? args[0] : "sim_config_waveform.properties";
        ...
        try {
            ...
            throw new RuntimeException("Cannot open Waveform output", e);
        }
        ...
        System.out.printf(Locale.US,
                "Waveform complete arm=%s summary_rows=%d expected=%d sample_rows=%d voxel_rows=%d%n",

package BSimReservoirPlanSweepS1;
...
/**
 * Sweep Step 1: one-AHL-source layout scout on the frozen Narma10b dish.
 * Only field.ahl.source.{x,y,z} may change. Acid stays (300,375,5).
 * Attractant AC0/AC2 stay silent. Kinetics are not retuned.
 */
public final class BSimReservoirPlanSweepS1 {
    ...
    static final class OutputOwner implements AutoCloseable {
        ...
        public void close() {
            ...
            try {
                ...
                throw new RuntimeException("Cannot close SweepS1 output", e);
            }
        }
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.printf(Locale.US,
                "SweepS1 AHL source=(%.4f, %.4f, %.4f) acid source=(%.4f, %.4f, %.4f)%n",
        ...
        try {
            ...
            throw new RuntimeException("Cannot open SweepS1 output", e);
        }
        ...
        System.out.printf(Locale.US,
                "SweepS1 complete arm=%s ahl=(%.1f,%.1f,%.1f) summary_rows=%d expected=%d sample_rows=%d voxel_rows=%d%n",
    ...
    static void writeSourcePositions(File directory) throws IOException {
        ...
        try (BufferedWriter w = new BufferedWriter(
            ...
            w.write("note=AHL inject uses field.ahl.source.{x,y,z}; attractants stay silent at AC0/AC2; acid is not moved\n");
        }
    }

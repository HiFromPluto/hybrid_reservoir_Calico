package BSimReservoirPlanStage6;
...
/**
 * Spatial Plan Stage 6. Copies frozen Stage 5 biology and tests it against a
 * Brownian density null and a silent-source control on NARMA-10.
 * Stage 4 remains FAIL. Stage 5 remains PASS. Mechanisms are not retuned.
 */
public final class BSimReservoirPlanStage6 {
    ...
    static final class OutputOwner implements AutoCloseable {
        ...
        public void close() {
            ...
            try {
                ...
                throw new RuntimeException("Cannot close Stage 6 output", e);
            }
        }
    }

    public static void main(String[] args) {
        String configPath = args.length > 0 ? args[0] : "sim_config_stage6.properties";
        ...
        try {
            ...
            throw new RuntimeException("Cannot open Stage 6 output", e);
        }
